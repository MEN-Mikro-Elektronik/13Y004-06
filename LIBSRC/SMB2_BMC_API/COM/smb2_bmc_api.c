...
/*-------------------------------[ History ]---------------------------------
 *
 * $Log: smb2_bmc_api.c,v $
 * Revision 1.3  2018/12/19 12:54:16  DPfeuffer
 * R:1. there is no working cluster implementation in any BMC
 *   2. SMB2BMC_StatusOutput_Set/SMB2BMC_GPO_Set/SMB2BMC_RTC_Set erroneous
 * M:1. removed cluster support
 *   2. fix SMB2BMC_StatusOutput_Set/SMB2BMC_GPO_Set/SMB2BMC_RTC_Set
 *
 * Revision 1.2  2015/08/14 17:53:31  awerner
